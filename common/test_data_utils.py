...
class TestDateUtils():
    def __init__(self,test_suitename,test_classname):
        ...
        self.excel_data=ExcelUtils(test_data_path,test_suitename).get_all_data_by_list()
        # self.excel_rows=ExcelUtils(test_data_path,test_suitename).get_row_count
    ...
    def convert_exceldata_to_testdata(self):
        ...
        #  }
        test_data_infos={}
        for i in range(self.excel_rows):
            test_data_info={}
...
if __name__=='__main__':
    infos = TestDateUtils('login_suite','LoginTest').convert_exceldata_to_testdata()
    value=TestDateUtils('login_suite', 'LoginTest')
    # for i in infos.values():
    print( infos )
    print(value.excel_rows)
